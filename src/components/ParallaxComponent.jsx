    ...
    <ParallaxWrapper>
      {props.direction === 'right' && (
        <Parallax x={[-40, 140]} y={[0, 0]}>
          <ParallaxPlane height={100} width={120} style={{height: '14rem'}} src={props.plane || undefined} alt="Plane" />
        </Parallax>
      )}
      {props.direction === 'left' && (
        <Parallax x={[140, -50]} y={[10, 50]}>
          <ParallaxPlane height={100} width={120} src={props.planeRight} alt="cloud two" />
        </Parallax>
      )}
      {props.variant === 'cloud' && (
        <Parallax x={[-40, 140]} y={[0, 0]}>
          <ParallaxPlane height={100} width={120} src={props.cloud} alt="cloud three" />
        </Parallax>
      )}
    </ParallaxWrapper>
  );
